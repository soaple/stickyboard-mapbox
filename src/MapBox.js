...
function MapBox(props) {
    ...
    const initMap = ({setMap, mapContainer}) =>{
      ...
      if(props.map.canvas.interactive !== undefined){
        mapOption.interactive = props.map.canvas.interactive;
      }
              ...
              Axios.get(urlByGps).then( res => {
                    ...
                    mMap.once('moveend', () => {
                      ...
                      .setHTML(`<h2> ${weatherInformation.name} </h2>
                       <p> 
                      <h3>
                       It's ${weatherInformation.weather.main}y (${weatherInformation.weather.description})<br>
                       Feels like ${weatherInformation.feels_like} 'C <br>
                       ...
                       Wind : Speed - ${weatherInformation.wind.speed}, Degree : ${weatherInformation.wind.deg}<br>
                       <br>
